...
public class CircuitBreakerConfiguration {
    ...
    public CircuitBreakerRegistry circuitBreakerRegistry() {
        CircuitBreakerRegistry registry = CircuitBreakerRegistry.of(getCircuitBreakerConfig());
    ...
    public CircuitBreaker aiServiceCircuitBreaker(CircuitBreakerRegistry registry) {
        return registry.circuitBreaker("aiService", getCircuitBreakerConfig());
    }

    @Bean
    public CircuitBreaker userServiceCircuitBreaker(CircuitBreakerRegistry registry) {
        return registry.circuitBreaker("userService", getCircuitBreakerConfig());
    }
}
